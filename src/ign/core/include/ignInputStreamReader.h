#ifndef _IGN_TOOLS_INPUTSTREAMREADER_H_
#define _IGN_TOOLS_INPUTSTREAMREADER_H_
...
namespace tools {
	...
	/// \brief Helper class to parse data from stream.
    ///
    /// It provides a transaction mecanism to parse data from input stream.
